...
exports.permute = [
//  { label: 'b', path: 'places.broadcastedBlips', values: [ 1, 5, 21, 89 ] },
//  { label: 'r', path: 'user.receivedBlips', values: [ 1, 5, 21, 89 ] },
  { label: 'x', path: 'users.behaviour.reportLocation.times', values: [ 1, 5, 21, 89 ] }
]

// test name
var name = exports.name = 'Report-Location Behaviour';
...
exports.tuneins = {
  areFresh: !true,
  users: {
    quantity: 30,                  // how many users each user is tuned into
    distribution: {
